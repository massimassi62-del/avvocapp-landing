          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-lg text-slate-600 font-medium leading-relaxed">
                La <strong>prova dell’app</strong> è pensata per offrire allo studio un’esperienza completa, trasparente e senza rischi, permettendo di utilizzare realmente tutte le funzionalità operative.
              </p>
            </div>
              ...
              <div className="bg-slate-50 rounded-3xl p-6 lg:p-10 border border-slate-200">
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 items-start">
                  ...
                  <div className="flex-grow">
                    <h3 className="text-2xl font-bold text-slate-900 mb-4 tracking-tight">🎁 Prova gratuita: utilizzo reale dell’app</h3>
                    <p className="text-slate-600 font-medium mb-6 leading-relaxed">
                      Per chi desidera testare l’app in modo operativo, è disponibile una <strong>prova gratuita</strong>, durante la quale lo studio può:
                    </p>
                    ...
                    <div className="p-4 bg-emerald-50 rounded-xl border border-emerald-100 text-sm text-emerald-800 font-semibold text-center mt-6">
                      Inizia subito senza impegno. Testa la potenza di AvvocApp con i tuoi processi quotidiani.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-white/5 rounded-2xl p-8 border border-white/10 text-center">
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-white text-slate-900 px-8 py-3 rounded-lg text-sm font-bold hover:bg-slate-100 transition-all text-center"
                >
                  Inizia ora gratis senza carta di credito <ArrowRight size={18} />
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {[
              ...
              { q: "Cosa succede dopo il periodo di prova?", a: "Al termine della prova potrai scegliere se sottoscrivere un abbonamento. Se decidi di non farlo, il tuo account verrà sospeso ma i dati rimarranno disponibili per l'esportazione per 60 giorni." },
